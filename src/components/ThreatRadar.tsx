  ...
  return (
    <div className="bg-[#171f33] border border-slate-800 rounded-2xl p-6 shadow-xl space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
        ...
        <div className="lg:col-span-5 flex flex-col items-center justify-center p-4 bg-[#0f172a] rounded-xl border border-slate-800 relative overflow-hidden min-h-[280px]">
          
          {/* Radar Circles */}
          <div className="w-52 h-52 rounded-full border border-cyan-500/20 relative flex items-center justify-center">
          ...
          <div className="mt-3 flex items-center justify-between w-full text-[10px] font-mono text-slate-500">
