    ...
    <div className="py-8 px-6 sm:px-10 space-y-6 max-w-[1720px] w-full mx-auto">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3.5">
        {[
          ...
          <div
            key={i}
            className="bg-[#171f33] border border-slate-800 hover:border-cyan-500/70 hover:shadow-[0_0_20px_rgba(6,182,212,0.25)] hover:-translate-y-1 transition-all duration-300 rounded-2xl p-4 cursor-pointer group"
          >
