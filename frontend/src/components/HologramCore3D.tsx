...
export const HologramCore3D: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Background Cyber Dust (Optimized count for 60fps)
    const bgDustCount = 60;
    ...
    // Inner Glowing Fusion Core
    const fusionGeo = new THREE.SphereGeometry(12, 16, 16);
    ...
    // =========================================================================
    // Ring X (Cyan) - Optimized segments for silky 60fps
    const ringXGeo = new THREE.TorusGeometry(32, 0.7, 8, 36);
    ...
    // Ring Y (Emerald)
    const ringYGeo = new THREE.TorusGeometry(36, 0.7, 8, 36);
    ...
    // Ring Z (Purple/Gold)
    const ringZGeo = new THREE.TorusGeometry(40, 0.8, 8, 36);
